...
| `modbus_tcp` | `spx_core/communications/modbus/modbus_tcp.py` | `tests/test_spx_core/test_communications/test_modbus_tcp/*` + API v3: `tests/test_spx_server/test_api_v3/test_modbus_*` | `spx-core/communications/modbus.md` | Docs aligned with current group/codec vocabulary and include the full Modbus family. |
