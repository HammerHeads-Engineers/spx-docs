...
See: [Use in Unit Tests (MiL)](../getting-started/use-in-unit-tests-mil.md), [Snapshots — Getting Started](../getting-started/snapshots-guide.md), [Communication Adapters](/broken/pages/Xj0Kch85KiFEX0H4nFce).
